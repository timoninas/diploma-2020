...
typedef struct edge {
    ...
    GraphLabels label;
    edge() = delete;
    edge(int number, point_t p1, point_t p2, int numberVertex1, int numberVertex2): numberEdge(number), points(std::make_pair(p1, p2)), numberVertices(std::make_pair(numberVertex1, numberVertex2)), label(GraphLabels::notvisited) { }
